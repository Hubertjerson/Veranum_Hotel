						...
						<?php if (isset($_COOKIE["codigoReserva"])) : ?>
							...
							<?php if ($validarPagoReserva) : ?>
								...
								<div class="card">
									...
									<div class="card-footer d-flex bg-white">
										...
										<form action="<?php echo $ruta . 'perfil'; ?>" method="POST" class="pt-3">
											<script src="https://www.mercadopago.cl/integrations/v1/web-tokenize-checkout.js" data-public-key="TEST-9fe0008c-f2e5-4a45-91a1-dde8373e6667" data-transaction-amount="<?php echo $_COOKIE['pagoReserva']; ?>" data-button-label="Pagar" data-summary-product-label="<?php echo $_COOKIE['infoHabitacion']; ?>" data-summary-product="<?php echo $_COOKIE['pagoReserva']; ?>">
											</script>
										</form>
								...
								if (isset($_REQUEST["token"])) {
									...
									MercadoPago\SDK::setAccessToken("TEST-3414316863855955-052820-a7d4d07015e0e774f0a0fd261ffe4056-1354879512");
